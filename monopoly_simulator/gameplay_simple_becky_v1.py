...
def before_agent(game_elements, num_active_players, num_die_rolls, current_player_index):
...
def after_agent(game_elements, num_active_players, num_die_rolls, current_player_index, actions_vector, a, params):
    ...
    if not current_player.currently_in_jail:
        ...
        move_actions = a.vector_to_actions(params['current_gameboard'], current_player,actions_vector)
